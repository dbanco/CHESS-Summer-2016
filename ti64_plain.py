...
xray_dir              = '/media/kswartz92/Swartz/Chess/ti64_plain/'
out_dir               = '/home/kswartz92/Documents/chess/ti64_plain/results/'
peak_dir              = '/home/kswartz92/Documents/chess/ti64_plain/peaks/'

row_skip              = 2        # rows on top and bottom
x_range               = [-6,6]   # mm
x_num                 = 5
z_range               = [-4,4]   # mm
z_num                 = 33
...
descrips              = ['initial', '1000N', '2500N', 'unload']
#%%
...
for i_step in range(n_step):         
    l_centers[i_step,:], l_errs[i_step,:], r_centers[i_step,:], r_errs[i_step,:], diams[i_step,:] = DataAnalysis.write_scan_diameters(xray_dir, out_dir, peak_dir, first_folders[i_step], first_file_nums[i_step], descrips[i_step], num_data_pts, strip_width, 'h', left, right)                            
#%%    read diameters
DataReader            = importlib.reload(DataReader)
